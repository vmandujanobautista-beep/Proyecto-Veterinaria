        ...
        <div class="bg-white rounded-2xl shadow-sm border border-slate-100 p-4 mb-5">
            <div class="flex flex-wrap gap-3 items-end">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <a :href="`{{ route('admin.reportes.pdf') }}?desde=${desde}&hasta=${hasta}`" target="_blank" class="mt-4 px-5 py-2 bg-slate-800 text-white text-sm font-medium rounded-xl hover:bg-slate-900 transition-colors flex items-center gap-2">
